...
<nav class="nav-6">
    ...
    <?php $pagesMenu = $this->request('Pages', 'getMenu');?>
                        <?php foreach($pagesMenu as $p): ?>
                            <?php if($p->slug != 'evenements/cirque/'):?>
...
<?php foreach ($pagesMenu as $p): ?>
    <?php if($p->slug == 'evenements/cirque/'):?>
        <h1 class="title-page title-<?php echo $p->id?>">Nos Cirques</h1>
    <?php endif;?>
<?php endforeach;?>
...
<img class="schema-footer" src="<?php echo Router::webroot('img/footer/footer-6.jpg')?>" alt="">
