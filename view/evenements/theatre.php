...
<nav class="nav-3">
    ...
    <?php $pagesMenu = $this->request('Pages', 'getMenu');?>
                        <?php foreach($pagesMenu as $p): ?>
                            <?php if($p->slug != 'evenements/theatre/'):?>
...
<?php foreach ($pagesMenu as $p): ?>
    <?php if($p->slug == 'evenements/theatre/'):?>
        <h1 class="title-page title-<?php echo $p->id?>">Nos Pièces de Theâtre</h1>
    <?php endif;?>
<?php endforeach;?>
...
<img class="schema-footer" src="<?php echo Router::webroot('img/footer/footer-3.jpg')?>" alt="">
