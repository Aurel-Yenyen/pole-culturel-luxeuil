...
<nav class="nav-5">
    ...
    <?php $pagesMenu = $this->request('Pages', 'getMenu');?>
                        <?php foreach($pagesMenu as $p): ?>
                            <?php if($p->slug != 'evenements/chorale/'):?>
...
<?php foreach ($pagesMenu as $p): ?>
    <?php if($p->slug == 'evenements/chorale/'):?>
        <h1 class="title-page title-<?php echo $p->id?>">Nos Chorales</h1>
    <?php endif;?>
<?php endforeach;?>
...
<img class="schema-footer" src="<?php echo Router::webroot('img/footer/footer-5.jpg')?>" alt="">
