...
<nav class="nav-4">
    ...
    <?php $pagesMenu = $this->request('Pages', 'getMenu');?>
                        <?php foreach($pagesMenu as $p): ?>
                            <?php if($p->slug != 'evenements/magie/'):?>
...
<?php foreach ($pagesMenu as $p): ?>
    <?php if($p->slug == 'evenements/magie/'):?>
        <h1 class="title-page title-<?php echo $p->id?>">Nos Spectacle de Magie</h1>
    <?php endif;?>
<?php endforeach;?>
...
<img class="schema-footer" src="<?php echo Router::webroot('img/footer/footer-4.jpg')?>" alt="">
